...
int64_t ct_istream::read(const clap_istream_t *stream, void *buffer, uint64_t size)
{
...
int64_t ct_ostream::write(const clap_ostream_t *stream, const void *buffer, uint64_t size)
{
